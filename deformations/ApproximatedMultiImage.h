...
/**
 * Specialization of ApproximatedMultiImage for BigLabelledMap container.
 *
 * @TODO: Common implementation with LabelledMap.
 */
template <
  typename TDomain,
  typename TData, std::size_t L, std::size_t N, std::size_t M,
  typename TApproximation,
  typename TBoundingBox
>
class ApproximatedMultiImage< TDomain, DGtal::BigLabelledMap<TData, L, N, M>, TApproximation, TBoundingBox >
  {
  public:
    ...
    // DGtal typedefs
    using Self          = ApproximatedMultiImage< TDomain, DGtal::BigLabelledMap<TData, L, N, M>, TApproximation, TBoundingBox >;
    using Domain        = TDomain; ///< Type of the domain.
    using Container     = DGtal::BigLabelledMap<TData, L, N, M>; ///< Type of the values container.
    using Approximation = TApproximation; ///< Type of the approximation.
    using BoundingBox   = TBoundingBox;   ///< Type of the bounding box.
    using Label         = typename Container::Label;  ///< Type of the label used to identify an image.
    using Value         = TData;  ///< Type of the stored values.
